...
| DPI | 속도 | 품질 | 권장 |
|---|:---:|:---:|---|
| **200** | 빠름 | 좋음 | **기본값 — 깔끔한 문서·텍스트 위주 슬라이드** |
| 250 | 보통 | 더 좋음 | 작은 글씨 섞임, OCR 누락 페이지 재변환 |
| 300 | 느림 | 최고 | 손그림·NotebookLM 출력 등 배경이 복잡할 때 (LaMa 인페인팅 잔재 최소화) |

> 150 DPI 이하는 OCR 정확도와 LaMa 인페인팅 품질이 뚜렷이 떨어져서 옵션에서 제외했습니다.
...
### "한국어가 깨져 나온다"
PaddleOCR(`lang='korean'`)이 본 프로젝트 기본값으로, 일반적으로 잘 됩니다. 깨지는 경우는 보통:
