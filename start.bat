...
if exist .venv\Scripts\python.exe (
    .venv\Scripts\python.exe -c "import torch; import uvicorn, fastapi, pypdfium2, paddleocr, simple_lama_inpainting" >nul 2>nul
    if not errorlevel 1 (
...
if "!PYTHON_CMD!"=="" (
    ...
    python -c "import torch; import uvicorn, fastapi, pypdfium2, paddleocr, simple_lama_inpainting" >nul 2>nul
    if not errorlevel 1 (
